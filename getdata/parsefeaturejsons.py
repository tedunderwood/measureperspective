...
if __name__ == "__main__":
    ...
    # Different division modes are possible.

    # In my work for "A Measured Perspective," I wanted to divide
    # long novels into parts that typically ranged from 30,000 to
    # 70,000 words. This meant that most novels were divided into
    # two parts — while some remained undivided, and some were
    # divided into three or more parts.

    # That scheme is defined by the following list

    cut_points = [0, 60000, 140000, 300000, 10000000]

    # We use that by iterating through to find the index of the first
    # number larger than the number of bodytokens in the volume.

    # We then divide the volume into *index* number of parts. I.e.,
    # since 140000 is index 2, all vols between 60k and 140k words will
    ...
    # You will need to change this if you're using it on your own machine.
